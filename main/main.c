 ...
 *  passed. It is assumed the binary name given in the Project binaryFile is the same as the one used in this program.
 *
 *      INDETERMINATE BEHAVIOURS:
...
int main(int argc, char *argv[]) {
    int choice = -1;
    char binaryName[MAXWORDSIZE] = "binary.bin";
